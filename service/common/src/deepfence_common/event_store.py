...
def serialize_detection_event(result: DetectionResult) -> dict[str, object]:
    ...
    return {
        ...
        "matched_behaviors": list(result.matched_behaviors),
        ...
        "total_payload_bytes": metadata.get("total_payload_bytes"),
        "http_is_plaintext": metadata.get("http_is_plaintext"),
        "http_method": metadata.get("http_method"),
        "http_path": metadata.get("http_path"),
        "http_query": metadata.get("http_query"),
        "http_host": metadata.get("http_host"),
        "http_user_agent": metadata.get("http_user_agent"),
        "dns_queries": metadata.get("dns_queries"),
        "dns_query_types": metadata.get("dns_query_types"),
